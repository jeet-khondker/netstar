const requests = {
    ...
    fetchOriginals : `/discover/tv?api_key=${ process.env.REACT_APP_API_KEY }&with_networks=213`,
    ...
    searchMovie : `/search/movie?api_key=${ process.env.REACT_APP_API_KEY }&query=`,
}
